        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.blog_section_update', $static->language_id) }}" method="POST" >
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="blog_title" placeholder="{{ __('Title') }}" value="{{ $static->blog_title }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="blog_sub_title" placeholder="{{ __('Subtitle') }}" value="{{ $static->blog_sub_title }}">
