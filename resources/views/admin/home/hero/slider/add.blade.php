                    ...
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('admin.slider'). '?language=' . $currentLang->code }}" class="btn btn-primary btn-sm">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="button_link" placeholder="{{ __('Button link') }}" value="{{ old('button_link') }}">
