            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1">{{ __('Add Team') }}</h3>
                                ...
                                <form class="form-horizontal" action="{{ route('admin.team.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            @endif
                                            <p class="help-block text-info">{{ __('Upload 570X650 (Pixel) Size image for best quality.
                                    ...
                                    <div class="form-group row">
                                        <label for="designation" class="col-sm-2 control-label">{{ __('Designation') }}<span class="text-danger">*</span></label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="dagenation" placeholder="{{ __('Designation') }}" value="{{ old('dagenation') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="description" class="form-control summernote" rows="5" placeholder="{{ __('Description') }}">{{ old('description') }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="icon1" placeholder="{{ __('Social Icon 1') }}" value="{{ old('icon1') }}">
                                            @if ($errors->has('icon1'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="url1" placeholder="{{ __('Social Url 1') }}" value="{{ old('url1') }}">
                                            @if ($errors->has('url1'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="icon2" placeholder="{{ __('Social Icon 2') }}" value="{{ old('icon2') }}">
                                            @if ($errors->has('icon2'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="url2" placeholder="{{ __('Social Url 2') }}" value="{{ old('url2') }}">
                                            @if ($errors->has('url2'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" name="icon3" placeholder="{{ __('Social Icon 3') }}" value="{{ old('icon3') }}">
                                            @if ($errors->has('icon3'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="url3" placeholder="{{ __('Social Url 3') }}" value="{{ old('url3') }}">
                                            @if ($errors->has('url3'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" name="icon4" placeholder="{{ __('Social Icon 4') }}" value="{{ old('icon4') }}">
                                            @if ($errors->has('icon4'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="url4" placeholder="{{ __('Social Url 4') }}" value="{{ old('url4') }}">
                                            @if ($errors->has('url4'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" name="icon5" placeholder="{{ __('Social Icon 5') }}" value="{{ old('icon5') }}">
                                            @if ($errors->has('icon5'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="url5" placeholder="{{ __('Social Url 5') }}" value="{{ old('url5') }}">
                                            @if ($errors->has('url5'))
