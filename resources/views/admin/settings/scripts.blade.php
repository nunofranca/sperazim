                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.commonsetting.updateScripts') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" {{ $commonsetting->is_google_analytics == '1' ? 'checked' : '' }} data-size="large" name="is_google_analytics" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="Active" data-label-text="<i class='fas fa-mouse'></i>"  data-off-text="Deactive">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" {{ $commonsetting->is_recaptcha == '1' ? 'checked' : '' }} data-size="large" name="is_recaptcha" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="Active" data-label-text="<i class='fas fa-mouse'></i>"  data-off-text="Deactive">
