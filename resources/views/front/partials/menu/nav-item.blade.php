...
<div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            ...
            @endif" href="duvidas-frequentes">{{ __('Portal do Cliente') }}</a>
        </li>
        @endif        
        @if( $commonsetting->contact_page == 1)
        <li class="nav-item">
            <a class="nav-link @if(request()->path() == 'contact') active  @endif" href="{{ route('front.contact') }}">{{ __('Central de Atendimento') }}</a>
        </li>
        @endif
    </ul>
</div> <!-- navbar collapse -->
...
<div class="navbar-btn mr-100 ml-30 d-none d-lg-block">
    <a class="main-btn" href="http://suporte-speranzini.ddns.net:86/" target="_blank">{{ __('Área do Cliente') }} <i class="fal fa-long-arrow-right"></i></a>
</div>
@endif