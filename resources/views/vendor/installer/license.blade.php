        ...
        <form method="post" action="{{ route('LaravelInstaller::licenseCheck') }}" class="tabs-wrap">
            ...
            <div>
                <div class="form-group {{ $errors->has('email') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="email" id="email" value="nulljungle@gmail.com" placeholder="Your Mail Address" />
                ...
                <div class="form-group {{ $errors->has('username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="username" id="username" value="nulljungle" placeholder="Username of Your Envato Account" />
                ...
                <div class="form-group {{ $errors->has('purchase_code') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="purchase_code" id="purchase_code" value="nulljungle.com" placeholder="Your Item Purchase Code" />
